...
return new class extends Migration
{
    ...
    {
        Schema::create('purchase_return_item_parts', function (Blueprint $table) {
            $table->id();
            $table->foreignId('purchase_return_item_id')->constrained()->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('purchase_return_item_parts');
    }
};
