...
<head>
    ...
    <style>
        :root {
            ...
            --label-h:   37mm;
            --unit-w:    41.5mm;
            --barcode-w: 12mm; /* the physical max this half-tag can hold (unit is 41.5mm minus 1.8mm padding each side); pushed to the ceiling to give the barcode every fraction of a mm it can get */
        }
